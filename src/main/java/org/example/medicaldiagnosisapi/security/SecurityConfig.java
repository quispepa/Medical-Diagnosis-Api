package org.example.medicaldiagnosisapi.security;


import lombok.RequiredArgsConstructor;
import org.example.medicaldiagnosisapi.security.filters.CustomAuthenticationFilter;
import org.example.medicaldiagnosisapi.security.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(PATCH, "/api//api/patient/updateName/{id}").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(GET, "/api/table-bookings").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
